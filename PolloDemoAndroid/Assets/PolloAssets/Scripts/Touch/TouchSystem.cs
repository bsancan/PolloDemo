...
public class TouchSystem : MonoBehaviour {
    ...
    public static List<FingerSystem> Fingers = new List<FingerSystem>();

    // This list contains all currently inactive fingers (e.g. this allows for pooling and tapping)
    public static List<FingerSystem> InactiveFingers = new List<FingerSystem>();
    ...
    public static System.Action<FingerSystem> OnFingerTap;
    ...
    public static System.Action<FingerSystem> OnFingerSwipe;
    ...
    public static System.Action<FingerSystem> OnFingerHeldDown;
    ...
    public static System.Action<FingerSystem> OnFingerHeldSet;
    ...
    public static System.Action<FingerSystem> OnFingerHeldUp;
    ...
    // This allows you to drag an object on screen by a change in screen position
    public static void MoveObjectInX(Transform transform, Vector2 deltaPosition, float speed, Camera camera = null)
    {
        if (transform != null)
        {
            if (deltaPosition.x != 0.0f || deltaPosition.y != 0.0f)
            {
                ...
                {
                    transform.position = MoveObjectInX(transform.position, deltaPosition, speed, camera);
                }
            }
        }
    }

    public static Vector3 MoveObjectInX(Vector3 worldPosition, Vector2 deltaPosition, float speed, Camera camera = null)
    {
        if (camera == null) camera = Camera.main;
        ...
        if (camera != null)
        {
            ...
            // Modify screen position and Delta only for x 
            screenPosition = screenPosition + (new Vector3(deltaPosition.x,0f,0f) * speed * Time.deltaTime);
            //screenPosition = screenPosition + (Vector3)(deltaPosition * speed * Time.deltaTime);
