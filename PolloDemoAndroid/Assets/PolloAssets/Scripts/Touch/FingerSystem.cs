...
public class FingerSystem  {
    ...
    public bool IsActive
    {
        get
        {
            return TouchSystem.Fingers.Contains(this);
        }
    }
    ...
    public Vector2 ScaledDeltaScreenPosition
    {
        get
        {
            return DeltaScreenPosition * TouchSystem.ScalingFactor;
        }
    }
    ...
    public Vector2 ScaledTotalDeltaScreenPosition
    {
        get
        {
            return TotalDeltaScreenPosition * TouchSystem.ScalingFactor;
        }
    }
    ...
    public Vector2 SwipeDelta
    {
        get
        {
            ...
            {
                return GetSnapshotDelta(TouchSystem.Instance.TapThreshold);
            }
    ...
    public Vector2 ScaledSwipeDelta
    {
        get
        {
            return SwipeDelta * TouchSystem.ScalingFactor;
        }
    }
    ...
    public float ScaledTotalDeltaMagnitude
    {
        get
        {
            return TotalDeltaMagnitude * TouchSystem.ScalingFactor;
        }
    }
    ...
    {
        return GetSnapshotDelta(deltaTime) * TouchSystem.ScalingFactor;
    }
